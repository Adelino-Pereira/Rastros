...
test('esconde a numeração nos objetivos (1 e 2) quando se alcança o objetivo', () => {
  ...
  const labelsA = Array.from(container.querySelectorAll('.goal-label')).map(n => n.textContent)
  ...
  const labelsB = Array.from(container.querySelectorAll('.goal-label')).map(n => n.textContent)
  ...
  const labelsC = Array.from(container.querySelectorAll('.goal-label')).map(n => n.textContent)
